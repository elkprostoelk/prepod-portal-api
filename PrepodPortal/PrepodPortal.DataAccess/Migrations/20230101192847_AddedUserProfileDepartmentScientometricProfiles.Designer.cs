...
namespace PrepodPortal.DataAccess.Migrations
{
    ...
    [Migration("20230101192847_AddedUserProfileDepartmentScientometricProfiles")]
    partial class AddedUserProfileDepartmentScientometricProfiles
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrepodPortal.DataAccess.Entities.UserProfile", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PrepodPortal.DataAccess.Entities.ScientometricDbProfile", b =>
                {
                    b.HasOne("PrepodPortal.DataAccess.Entities.UserProfile", "UserProfile")
            ...
            modelBuilder.Entity("PrepodPortal.DataAccess.Entities.UserProfile", b =>
                {
                    ...
                    b.HasOne("PrepodPortal.DataAccess.Entities.ApplicationUser", "User")
                        .WithOne("UserProfile")
                        .HasForeignKey("PrepodPortal.DataAccess.Entities.UserProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
