...
namespace PrepodPortal.DataAccess.Migrations
{
    ...
    [Migration("20230619191356_QualIncreaseInternshipThemeNullable")]
    partial class QualIncreaseInternshipThemeNullable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrepodPortal.DataAccess.Entities.QualificationIncrease", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("InternshipTheme")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.ToTable("QualificationIncreases");
                });
            ...
            modelBuilder.Entity("PrepodPortal.DataAccess.Entities.Subject", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PrepodPortal.DataAccess.Entities.QualificationIncrease", b =>
                {
                    b.HasOne("PrepodPortal.DataAccess.Entities.ApplicationUser", "User")
                        .WithMany("QualificationIncreases")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PrepodPortal.DataAccess.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("QualificationIncreases");
